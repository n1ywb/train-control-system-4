...
protected:
   AbstractStreamHttpReply(Stream& stream, const String& contentType, const String& code, const String& headers="");
...
{
public:
    StreamHttpErrorReply(Stream& stream, const String& contentType, const String& code = "400", const String& headers="");
...
{
public:
    StreamHttpReply(Stream& stream, const String& contentType, const String& headers="");
